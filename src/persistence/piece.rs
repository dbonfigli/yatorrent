...
impl Piece {
    ...
    pub fn overlaps(&self, begin: u64, end: u64) -> bool {
        ...
        self.fragments
            .iter()
            .any(|fragment| begin <= fragment.end && end >= fragment.begin)
    }
...
mod tests {
    ...
    fn test_overlaps() {
        ...
        assert!(piece.overlaps(10, 20));
        assert!(piece.overlaps(15, 15));
        assert!(piece.overlaps(5, 10));
        assert!(piece.overlaps(20, 25));
        assert!(piece.overlaps(5, 25));
        assert!(piece.overlaps(15, 35));

        assert!(!piece.overlaps(0, 9));
        assert!(!piece.overlaps(21, 29));
        assert!(!piece.overlaps(41, 49));
    }
